...
export class CreateAll1761917768110 implements MigrationInterface {
    name = 'CreateAll1761917768110'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "mail" character varying NOT NULL, "password" character varying NOT NULL, "direction" character varying NOT NULL, "phone" character varying NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "prdoductos" ADD CONSTRAINT "FK_d3a64e51a90657a6ae91252d2ae" FOREIGN KEY ("categoriaId") REFERENCES "categoria"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "pedido_producto" ADD CONSTRAINT "FK_da007c96a1af3dbf6a925bf6581" FOREIGN KEY ("productoId") REFERENCES "prdoductos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "prdoductos" DROP CONSTRAINT "FK_d3a64e51a90657a6ae91252d2ae"`);
        ...
        await queryRunner.query(`DROP TABLE "prdoductos"`);
